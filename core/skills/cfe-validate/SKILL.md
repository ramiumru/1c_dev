...
```powershell
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/cfe-validate.ps1" -ExtensionPath "src"
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/cfe-validate.ps1" -ExtensionPath "src/Configuration.xml"
```

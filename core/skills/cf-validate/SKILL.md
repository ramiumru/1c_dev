...
```powershell
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/cf-validate.ps1" -ConfigPath "upload/cfempty"
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/cf-validate.ps1" -ConfigPath "upload/cfempty/Configuration.xml"
```

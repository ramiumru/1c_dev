...
```powershell
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/subsystem-validate.ps1" -SubsystemPath "Subsystems/Продажи"
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/subsystem-validate.ps1" -SubsystemPath "Subsystems/Продажи.xml"
```

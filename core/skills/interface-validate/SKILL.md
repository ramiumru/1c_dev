...
```powershell
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/interface-validate.ps1" -CIPath "Subsystems/Продажи"
powershell.exe -NoProfile -File "{{SKILL_DIR}}/scripts/interface-validate.ps1" -CIPath "Subsystems/Продажи/Ext/CommandInterface.xml"
```

...
- **Запросы:** предпочитать запросы вместо процедурной обработки, когда задача естественно выражается выборкой, группировкой, соединением или агрегацией; выбор архитектурный, а не только по объёму данных (см. «Ключевые принципы 1С-разработки» в `1c-developer.md`).
